...
const SvgDynamodb = (props) => (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", xmlSpace: "preserve", style: {
    ...
    React.createElement("path", { d: "M165.258 288.501h3.508l57.261-28.634.953-1.347V29.964l-.953-1.354L168.766 0h-3.551z", style: {
            fill: "#5294cf",
            fillRule: "nonzero",
        }, transform: "translate(4.95 5.828)scale(.96132)" }),
    React.createElement("path", { d: "M90.741 288.501h-3.557l-57.212-28.634-1.161-1.997-.589-226.742 1.75-2.518L87.184 0h3.601z", style: {
            fill: "#1f5b98",
            fillRule: "nonzero",
        }, transform: "translate(4.95 5.828)scale(.96132)" }),
