...
const SvgVscode = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width={2500} height={2455} viewBox="-11.9 -2 1003.9 995.6" {...props}>
    <path fill="#2489ca" d="M12.1 353.9s-24-17.3 4.8-40.4l67.1-60s19.2-20.2 39.5-2.6l619.2 468.8v224.8s-.3 35.3-45.6 31.4z"/>
    <path fill="#1070b3" d="M171.7 498.8 12.1 643.9s-16.4 12.2 0 34l74.1 67.4s17.6 18.9 43.6-2.6L299 614.4z"/>
    <path fill="#0877b9" d="m451.9 500 292.7-223.5-1.9-223.6s-12.5-48.8-54.2-23.4L299 384z"/>
