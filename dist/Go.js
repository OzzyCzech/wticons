...
const SvgGo = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  d: "m29.5 26.8-.3-.1c-7-2-6.9-7-6.7-8.5.5-3.8 4.1-7.8 8.9-7.8 1.9 0 3.7.6 5.5 1.8l.3.2-7.7 14.4zm1.9-15.7c-4.5 0-7.8 3.7-8.3 7.2-.5 3.6 1.7 6.4 6 7.7l7.1-13.5c-1.5-.9-3.1-1.4-4.8-1.4z",
  clipPath: "url(#go_svg__b)"
}), /*#__PURE__*/React.createElement("path", {
  fill: "#6AD7E5",
  fillRule: "evenodd",
  ...
  d: "M97.5 25.3 89.2 11l.3-.2c1.9-1.3 3.8-2 5.7-2 4.6 0 7.9 3.8 8.6 7.5.3 1.5.6 6.6-6 8.8l-.3.2zm-7.4-14 7.7 13.3c3.9-1.4 5.9-4.4 5.3-8-.6-3.4-3.7-6.9-7.9-6.9-1.7-.1-3.4.4-5.1 1.6z",
  clipPath: "url(#go_svg__b)"
}), /*#__PURE__*/React.createElement("path", {
  fill: "#F6D2A2",
  fillRule: "evenodd",
