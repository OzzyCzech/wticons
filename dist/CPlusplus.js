...
const SvgCPlusplus = (props) => (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", xmlSpace: "preserve", style: {
    ...
    React.createElement("path", { d: "M128.392 143.476 2.993 215.678c2.056 3.717 5.177 6.824 9.401 9.269 20.239 11.722 88.164 50.629 101.726 58.631 9.121 5.382 18.027 5.575 27.215.27 34.07-19.672 68.186-39.262 102.272-58.913 4.224-2.444 7.345-5.553 9.401-9.267l-124.616-72.192", style: {
            fill: '#004482',
            fillRule: 'nonzero',
        } }),
    React.createElement("path", { d: "M91.25 164.863c7.297 12.738 21.014 21.33 36.75 21.33 15.833 0 29.628-8.701 36.888-21.576l-36.496-21.141-37.142 21.387", style: {
            fill: '#1a4674',
            fillRule: 'nonzero',
        } }),
