...
var SvgTiktok = function (props) { return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", xmlSpace: "preserve", style: {
    ...
    React.createElement("path", { d: "M175.803 92.849c18.683 13.344 41.561 21.195 66.272 21.195V76.631c-13.794-2.937-26.005-10.141-35.186-20.162-15.715-9.802-27.038-25.972-30.358-44.898h-34.643v189.843c-.079 22.132-18.049 40.052-40.21 40.052-13.058 0-24.66-6.221-32.007-15.859-13.121-6.619-22.118-20.207-22.118-35.899 0-22.193 18-40.187 40.208-40.187 4.255 0 8.356.662 12.203 1.882v-37.822c-47.692.985-86.047 39.933-86.047 87.834 0 23.912 9.551 45.589 25.053 61.428 13.985 9.385 30.821 14.859 48.934 14.859 48.545 0 87.9-39.334 87.9-87.856V92.849h-.001Z", style: {
            fillRule: 'nonzero',
        }, transform: "translate(65.742 7.726) scale(3.48649)" }),
